...
public class SmartSwitchProvider extends ContentProvider {
    private static final String TAG = "LauncherProvider";

    private SmartSwitchDatabaseHelper dbHelper;

    @Override
    public boolean onCreate() {
        dbHelper = new SmartSwitchDatabaseHelper(getContext());
        return true;
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        if (Constant.TABLE_DOWNLOAD.equals(args.table)) {
            c = db.query(Constant.TABLE_DOWNLOAD, projection, selection,
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        try {
            rowId = db.insert(args.table, Constant.ID, values);
